	...
	<body>
		...
		<div id="show-user" class="content scaffold-show" role="main">
			...
			<ol class="property-list user">
				...
				<g:if test="${userInstance?.docs}">
				<li class="fieldcontain">
					<span id="docs-label" class="property-label"><g:message code="user.docs.label" default="Docs" /></span>
					
						<g:each in="${userInstance.docs}" var="d">
						<span class="property-value" aria-labelledby="docs-label"><g:link controller="doc" action="show" id="${d.id}">${d?.encodeAsHTML()}</g:link></span>
						</g:each>
